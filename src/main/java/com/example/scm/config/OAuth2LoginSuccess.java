...
public class OAuth2LoginSuccess implements AuthenticationSuccessHandler {
    ...
    Logger log = LoggerFactory.getLogger(OAuth2LoginSuccess.class);
    ...
    public void onAuthenticationSuccess(
        ...
        User user = User
                .builder()
                .rolesList(List.of(UserRole.NORMAL.toString()))
                .emailVerified(true)
                .enabled(true)
                .password(null)
                .build();
        ...
        switch (clientId) {
            case "google":
                oAuth2User.getAttributes().forEach((key, val) -> System.out.println(key + " : " + val));
